<html>
<head>
<title>Personal Information Webpage (POST)</title>
<style type="text/css">
	body {
		font-family: arial;
...
<body>
	...
	<?php
		...
		if ($_SERVER["REQUEST_METHOD"] == "POST") {
			...
			//after 10 seconds
			sleep(10);
			echo "<br><b>Cookies </b><br><br>";
			echo '<b>After 10 seconds: </b>'. $_COOKIE['firstname'].' ';
			echo  $_COOKIE['middlename'].' ';
			echo  $_COOKIE['lastname'].'<br><br>';
			
			//after 20 seconds
			sleep(10);
			echo '<b>After 20 seconds: </b>'. $_COOKIE['firstname'].' ';
			echo  $_COOKIE['middlename'].' ';
			echo  $_COOKIE['lastname'].'<br><br>';
			
			//after 30 seconds
			sleep(10);
			echo '<b>After 30 seconds: </b>'. $_COOKIE['firstname'].' ';
			echo  $_COOKIE['middlename'].' ';
			echo  $_COOKIE['lastname'].'<br><br>';
		}
	?>
